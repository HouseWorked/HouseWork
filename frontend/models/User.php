...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['auth_key', 'created_at', 'updated_at', 'role_id'], 'required'],
            [['status', 'created_at', 'updated_at', 'teem_id', 'proff_id', 'phone'], 'integer'],
            [['username', 'password_hash', 'password_reset_token', 'email', 'vk', 'skype', 'odnoklassniki', 'facebook', 'instagram'], 'string', 'max' => 255],
